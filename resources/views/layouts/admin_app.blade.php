...
--}}
                    <a class="collapse-item" href="buttons.html">Permissions</a>
            ...
            <div id="collapseTwo3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    {{--
                                        <h6 class="collapse-header">User Management:</h6>
                    --}}
                    <a class="collapse-item" href="{{route('lessons.index')}}">View lessons</a>
                    <a class="collapse-item" href="{{route('lessons.create')}}">Add lesson</a>
            ...
            <div id="collapseTwo6" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    {{--
                                        <h6 class="collapse-header">User Management:</h6>
                    --}}
                    <a class="collapse-item" href="{{route('tests.index')}}">View tests</a>
